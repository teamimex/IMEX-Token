...
contract Ownable {
    ...
    event MagegerTransferred(address indexed previousManager, address indexed newManager);
...
contract ManagedToken is StandardToken, Ownable {
    ...
    * @param _value uint256 the amount of tokens to be transferred
    */
    function managedTransferFrom(address _from, address _to, uint256 _value) public onlyManager returns (bool) {
        require(_to != address(0));
        require(_value <= balances[_from]);
